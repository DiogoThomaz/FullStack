...
export class SquadController {
  ...
  @Get('/gestor/:id')
  findByGestor(@Param('id') id: string) {
    return this.squadService.findSquadByGestor(id);
  }

  @Get('/my-squads/:id')
  findAllSquadsOfGestor(@Param('id') id: string) {
    return this.squadService.findMySquads(id)
  }
